...
const initialSupports = [
  ...
  { id: 2, position: 3000, type: 'roller' },
];

const initialPointLoads = [{ id: 1, position: 1500, magnitude: 8 }];
const initialUdls = [{ id: 1, start: 0, end: 3000, intensity: 1.5 }];
